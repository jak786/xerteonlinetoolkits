...
function is_template_rss($template_id){
	...
	$query = "select template_id from " . $xerte_toolkits_site->database_table_prefix . "templatesyndication where template_id=\"" . $template_id . "\" and rss=\"true\"";
...
function is_template_syndicated($template_id){
	...
	$query = "select template_id from " . $xerte_toolkits_site->database_table_prefix . "templatesyndication where template_id=\"" . $template_id . "\" and syndication=\"true\"";
...
function is_template_exportable($template_id){
	...
	$query = "select template_id from " . $xerte_toolkits_site->database_table_prefix . "templatesyndication where template_id=\"" . $template_id . "\" and export=\"true\"";
...
function is_template_shared($template_id){
	...
	$query = "select template_id from" . $xerte_toolkits_site->database_table_prefix . "templaterights where template_id=\"" . $template_id . "\"";
...
function is_user_creator($template_id){
	...
	$query_for_template_status = "select role from " . $xerte_toolkits_site->database_table_prefix . "templaterights where template_id=\"" . $template_id . "\" AND user_id=\"" . $_SESSION['toolkits_logon_id'] . "\"";
