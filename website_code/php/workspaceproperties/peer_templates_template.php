...
*/
	...
	require $xerte_toolkits_site->root_file_path . "languages/" . $_SESSION['toolkits_language'] . "/website_code/php/workspaceproperties/peer_templates_template.inc";
	...
	*/
	...
	while($row_template_name = mysql_fetch_array($query_peer_response)){
		...
		echo "<div style=\"float:left; width:60%;\">" . $row_template_name['template_name'] . "</div><div style=\"float:left; width:20%;\"> " . PEER_REVIEW_STATUS . " </div>";
