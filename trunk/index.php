                ...
                <div class="mainbody_holder">
                    <div class="mainbody_div_2">
                        ...
                        <div class="news">
                            ...
                            <p class="news_story">
                                <?php echo INDEX_HELP_INTRODUCTION; ?><br><br><a href="<?php echo $xerte_toolkits_site->demonstration_page; ?>" target="new"><?php echo INDEX_HELP_INTRO_LINK_TEXT; ?></a>
                                        </p>
                                        </div>
                                        <div class="border"></div>
                                        <div class="news">
                                    ...
                                    // TODO $_POST['login'] could contain nasty stuff ... I guess? How should it be sanitised/escaped/cleaned?
